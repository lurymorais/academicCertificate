...
1. **Download** `academicCertificate.tar.gz` from [GitHub Releases](https://github.com/ssemerikov/academicCertificate/releases)
...
5. **Select** the downloaded `academicCertificate.tar.gz` file
...
1. **Upload the plugin:**
   ...
   git clone https://github.com/ssemerikov/academicCertificate.git
...
2. **Set permissions:**
   ```bash
   chmod -R 755 academicCertificate/
   chown -R www-data:www-data academicCertificate/  # Adjust user as needed
   ```
...
cd /path/to/ojs/plugins/generic/
git clone https://github.com/ssemerikov/academicCertificate.git
cd academicCertificate && composer install && cd ..
chmod -R 755 academicCertificate/
```
...
Report issues at: https://github.com/ssemerikov/academicCertificate/issues
