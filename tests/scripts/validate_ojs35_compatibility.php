...
$classLoadingTest = new \APP\plugins\generic\academicCertificate\tests\compatibility\ClassLoadingTest();
...
$requiredFiles = [
    ...
    'classes/migration/AcademicCertificateInstallMigration.php',
...
$namespaceChecks = [
    ...
    'AcademicCertificatePlugin.php' => [
        'pattern' => '/class\s+AcademicCertificatePlugin\s+extends\s+\\\\PKP\\\\plugins\\\\GenericPlugin/',
...
$migrationFile = $pluginDir . '/classes/migration/AcademicCertificateInstallMigration.php';
...
if ($allPassed) {
    ...
    echo "  • GitHub: https://github.com/ssemerikov/academicCertificate/issues\n";
