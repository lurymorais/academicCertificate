...
require_once BASE_SYS_DIR . '/AcademicCertificatePlugin.php';
require_once BASE_SYS_DIR . '/classes/CertificateDAO.php';

use APP\plugins\generic\academicCertificate\AcademicCertificatePlugin;
use APP\plugins\generic\academicCertificate\classes\CertificateDAO;
...
class OJS33CompatibilityTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AcademicCertificatePlugin();
    }
    ...
    public function testMigrationFileLoadsWithoutLaravel(): void
    {
        ...
        $migrationFile = BASE_SYS_DIR . '/classes/migration/AcademicCertificateInstallMigration.php';
        ...
        $this->assertTrue(
            class_exists('APP\plugins\generic\academicCertificate\classes\migration\AcademicCertificateInstallMigration'),
    ...
    public function testMigrationBaseClassIsConditional(): void
    {
        ...
        require_once BASE_SYS_DIR . '/classes/migration/AcademicCertificateInstallMigration.php';

        $migration = new \APP\plugins\generic\academicCertificate\classes\migration\AcademicCertificateInstallMigration();
    ...
    public function testMigrationUsesRawSQLFallback(): void
    {
        ...
        $reflection = new \ReflectionClass('APP\plugins\generic\academicCertificate\classes\migration\AcademicCertificateInstallMigration');
