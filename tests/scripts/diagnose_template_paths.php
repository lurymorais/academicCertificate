 ...
 *    - Open AcademicCertificatePlugin.php
 ...
 *    [timestamp] AcademicCertificate: Template displayed: [template-path]
 *    [timestamp] AcademicCertificate: Matched template for certificate button: [template-path]
 *
 * 5. Report findings:
...
$pluginFile = $baseDir . '/AcademicCertificatePlugin.php';
$content = file_get_contents($pluginFile);

if (strpos($content, 'error_log("AcademicCertificate: Template displayed:') !== false) {
...
if ($errorLog && $errorLog !== 'syslog') {
    ...
    if (file_exists($errorLog)) {
        ...
        echo "─────────────────────────────────────────────────────────────\n";
        $cmd = "grep 'AcademicCertificate:' " . escapeshellarg($errorLog) . " 2>/dev/null | tail -10";
...
if ($errorLog && $errorLog !== 'syslog' && file_exists($errorLog)) {
    ...
    echo "  grep 'AcademicCertificate:' $errorLog | tail -50\n";
} else {
    echo "  grep 'AcademicCertificate:' /path/to/your/error.log | tail -50\n";
}
echo "\n";
...
echo "  • GitHub Issues: https://github.com/ssemerikov/academicCertificate/issues\n";
...
echo "\n";
echo "[timestamp] AcademicCertificate: Template displayed: reviewer/review/step1.tpl\n";
echo "[timestamp] AcademicCertificate: Template displayed: reviewer/review/step2.tpl\n";
echo "[timestamp] AcademicCertificate: Template displayed: reviewer/review/step3.tpl\n";
echo "[timestamp] AcademicCertificate: Template displayed: reviewer/review/step4.tpl\n";
echo "[timestamp] AcademicCertificate: Matched template for certificate button: reviewer/review/step4.tpl\n";
echo "[timestamp] AcademicCertificate: Certificate is available or reviewer is eligible - showing button\n";
echo "[timestamp] AcademicCertificate: Injected via echo (output buffering)\n";
echo "\n";
