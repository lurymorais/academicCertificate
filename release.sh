...
# Produces: academicCertificate-{VERSION}-3_3.tar.gz, -3_4.tar.gz, -3_5.tar.gz
#
...
PLUGIN_NAME="academicCertificate"
BUILD_DIR="$(mktemp -d)"
...
for OJS_VERSION in 3.3 3.4 3.5; do
  ...
  cp -r AcademicCertificatePlugin.php version.xml index.php "$DEST/"
