...
namespace APP\plugins\generic\academicCertificate\tests\Locale;
...
class LocaleValidationTest extends PHPUnitTestCase {
        ...
        foreach ($this->supportedLocales as $locale) {
            ...
            foreach ($xml->message as $message) {
                ...
                $this->assertStringStartsWith(
                    'plugins.generic.academicCertificate.',
                    $key,
                ...
                $this->assertMatchesRegularExpression(
                    '/^[a-z][a-zA-Z0-9.]*$/',
                    str_replace('plugins.generic.academicCertificate.', '', $key),
    ...
    public function testCriticalMessagesExist() {
        $criticalKeys = [
            'plugins.generic.academicCertificate.displayName',
            'plugins.generic.academicCertificate.description',
            'plugins.generic.academicCertificate.downloadCertificate',
            'plugins.generic.academicCertificate.settings',
            'plugins.generic.academicCertificate.error.accessDenied',
        ];
