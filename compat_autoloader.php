<?php
/**
 * @file plugins/generic/academicCertificate/compat_autoloader.php
 *
 * Copyright (c) 2024
...
if (!defined('ACADEMIC_CERTIFICATE_COMPAT_AUTOLOADER')) {
    define('ACADEMIC_CERTIFICATE_COMPAT_AUTOLOADER', true);
    ...
    spl_autoload_register(function ($class) {
        ...
        if (isset($classMap[$normalizedClass])) {
            ...
            error_log('AcademicCertificate: Autoloader failed to resolve ' . $class . ' -> ' . $globalClass);
        }
        return false;
